...
class Tribe
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Event", mappedBy="tribe")
     */
    private $events;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\User", mappedBy="tribe")
     */
    private $users;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Comment", mappedBy="tribe")
     */
    private $comments;
    ...
    public function removeComment(Comment $comment): self
    {
        if ($this->comments->contains($comment)) {
            ...
            // set the owning side to null (unless already changed)
            if ($comment->getTribe() === $this) {
                $comment->setTribe(null);
            }
        }
